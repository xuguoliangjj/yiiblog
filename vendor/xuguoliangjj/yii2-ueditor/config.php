...
return [
    ...
    "imageUrlPrefix" => "http://blogimg.loadata.com", /* 图片访问路径前缀 */
    ...
    "scrawlUrlPrefix" => "http://blogimg.loadata.com", /* 图片访问路径前缀 */
    "scrawlInsertAlign" => "none",

    /* 截图工具上传 */
    "snapscreenActionName" => "uploadimage", /* 执行上传截图的action名称 */
    "snapscreenPathFormat" => "/upload/image/{yyyy}{mm}{dd}/{time}{rand:6}", /* 上传保存路径,可以自定义保存路径和文件名格式 */
    "snapscreenUrlPrefix" => "http://blogimg.loadata.com", /* 图片访问路径前缀 */
    ...
    "catcherUrlPrefix" => "http://blogimg.loadata.com", /* 图片访问路径前缀 */
    ...
    "videoUrlPrefix" => "http://blogimg.loadata.com", /* 视频访问路径前缀 */
    ...
    "fileUrlPrefix" => "http://blogimg.loadata.com", /* 文件访问路径前缀 */
    ...
    "imageManagerUrlPrefix" => "http://blogimg.loadata.com", /* 图片访问路径前缀 */
    ...
    "fileManagerUrlPrefix" => "http://blogimg.loadata.com", /* 文件访问路径前缀 */
